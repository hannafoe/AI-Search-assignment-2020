...
class Node:
    def __init__(self,ID,state,parent,action,path_cost,depth):
        self.ID=ID
        self.state=state
        self.parent=parent
        self.action = action
...
def basic_greedy():
    ...
    while len(path)!=num_cities:
        ...
        for i in range(1,num_cities):#all successors
            ...
            new_node = Node(new_id,new_state,node.ID,new_dist,new_pathcost,new_depth)
