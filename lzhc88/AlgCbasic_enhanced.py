...
theta = 0.00001 #inertia function: weight to be give to particle's current velocity
alpha = 1.2 #cognitive learning factor: weight to be given to particle's own best position
beta = 1.9 #social leraning factor: weight to be given to the particle's neighbourhood's best position
...
def particle_swarm_opt():
    ...
    while t<max_it:
        for a in my_particles:
            ...
            dif_aBestTour_aCurTour = distance(current_tour.copy(),a.best_tour.copy()) #difference of a's best tour-a' current tour
            ...
            dif_nhoodBest_aCurTour = distance(current_tour.copy(),best_in_nhood.best_tour.copy())
